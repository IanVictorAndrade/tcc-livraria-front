        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-14 px-6">
                <div className="bg-white rounded-lg shadow-lg p-10 flex flex-col items-center text-center w-full max-w-md">
                    ...
                    <h2 className="font-bold text-xl mt-6">Ian Victor</h2>
                ...
                <div className="bg-white rounded-lg shadow-lg p-10 flex flex-col items-center text-center w-full max-w-md">
                    ...
                    <h2 className="font-bold text-xl mt-6">Fabio Marcelo Tanwing Saavedra</h2>
                ...
                <div className="bg-white rounded-lg shadow-lg p-10 flex flex-col items-center text-center w-full max-w-md">
                    ...
                    <h2 className="font-bold text-xl mt-6">Lívia Catarina</h2>
